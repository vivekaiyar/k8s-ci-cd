        ...
        stage('DockerHub Push'){
            steps{
                ...
                docker.withRegistry('https://art4lab0.labs.mastercard.com:5001', 'art4lab0-docker-deploy') {
                    ...
                    sh "docker tag "${ImageName}:${DOCKER_TAG}" "art4lab0.labs.mastercard.com:5001/artifactory/docker-internal/test/${ImageName}:${DOCKER_TAG}""
                    sh "docker push art4lab0.labs.mastercard.com:5001/artifactory/docker-internal/${ImageName}:${DOCKER_TAG}"
                }
                }
            }
        }
